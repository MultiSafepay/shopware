<?php
/**
 * Class for creating customfields, added to the FCO page.
 */
class MspCustomFields {
	...
	/**
	* AddField, add the field to the fields array
    */
	...
	/**
	* SetRaw, add row xml as extra xml data
    */
    function SetRaw($xml){
	...
	/**
	* getXml, get the transaction xml data
    */
    function GetXml(){
	...
	/**
	* get localized xml data for transaction
    */
