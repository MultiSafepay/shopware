    ...
    <div id="container">
      ...
      <div class="examples">
        <ul>
          ...
          <li><a href="<?php echo BASE_URL ?>controllers/updateController.php" style="color:#205081 !important;"><i class="fa msp-update fa-5x"></i><br/>Update Transaction</a></li>
          ...
          <li><a href="<?php echo BASE_URL ?>controllers/affiliateController.php?task=createsite" style="color:#000 !important;"><i class="fa msp-createsite fa-5x"></i><br/>Create website (as affiliate)</a></li>		
        </ul>
